<div class="cart-section">
    <ul>
        <a href="javascript:void(0);" wire:click="categoryFilter('women')">
            <li>Women's</li>
        </a>
        <a href="javascript:void(0);" wire:click="categoryFilter('men')">
            <li>Men's</li>
        </a>
        <a href="javascript:void(0);" wire:click="categoryFilter('sale')">
            <li>Sale</li>
        </a>
    </ul>
